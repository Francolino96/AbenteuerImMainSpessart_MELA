class AnswerScene extends Phaser.Scene {
    ...
    create() {
        ...
        const text_1 = this.add.text(this.scale.width/2, this.scale.height/2 - 140 * this.personalScale, "Seit wie\nvielen Jahren\nmachen wir\nEis in Lohr?", {
        ...
        const text_2 = this.add.text(this.scale.width/2, text_1.y + 180 * this.personalScale, "seit 43 Jahren", {
            fontFamily: "PressStart2P",
            fontSize: 35*this.personalScale, 
            fill: "#99f",
            align: 'center'
